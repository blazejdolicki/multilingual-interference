...
python metatest_all.py --validate True --lr_decoder 1e-03 --lr_bert 1e-04 --updates 20 --support_set_size 20 --optimizer sgd --episode 500 --model_dir logs/bert_finetune_en/2021.05.18_15.18.52
