...
python train_meta.py --inner_lr_decoder 1e-03 --inner_lr_bert 1e-04 --meta_lr_decoder 5e-04 --meta_lr_bert 1e-05 --updates 20 --episodes 500 --support_set_size 20 --model_dir logs/bert_finetune_en/2021.05.15_11.24.02