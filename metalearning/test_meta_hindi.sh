...
python metatest_all.py --lr_decoder 5e-04 --lr_bert 5e-05 --updates 20 --support_set_size 20 --optimizer sgd --model_dir logs/bert_finetune_hindi/2021.05.18_14.46.31/
